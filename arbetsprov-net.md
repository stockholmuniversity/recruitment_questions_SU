...
Hur gör du för att hitta en annan nätverksutrustning som är inkopplad i en switch eller router?
...
En lokal admin köper in all infrastruktur centralt men får för sig att sätta upp en egen brandvägg (cisco ASA) mellan era nät. Det stora flertalet klienter kommer inte ut på internet, medans vissa gör det. Vad har troligvis glömts i konfigurationen i ASA:n?
...
Vilken är din favoriteditor i terminalen?
...
Skriv en egen fråga med svar, motivering och rubrik så kanske den kommer med i framtida versioner av detta prov.